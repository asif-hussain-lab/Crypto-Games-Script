...
if ($withdraw_amount < $min_withdraw_amount) {
  $min_w_error = '<div class="ui negative message"><div class="header">Minimum amount to Withdraw is '.number_decimal($min_withdraw_amount).' '.$base_currency_u.' .</div></div>';
...
$reduceuserbalance = ReduceUserBalance($useraddress, $amount);
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm">
<h2 style="color: purple;">Withdraw Your Earnings From Main Balance</h2>
      <br>
      <!-- This Message Have Information About User Total Balance -->
...
<p>Minimum Withdrawal Amount is : <a class="ui violet label"<b><?php echo number_decimal($min_withdraw_amount); ?> <?php echo $base_currency_u; ?></b></a></p>
<br>
