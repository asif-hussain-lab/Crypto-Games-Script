...
$min_amount_luckynumber = $_POST['min_amount_luckynumber'];


if (!ctype_digit($min_amount_luckynumber)) {  
...
$updateuser = UpdateLuckyNumber($min_amount_luckynumber);
...
<div class='column'> 
<center><h1>LuckyNumber Settings</h1>
<br>
<br>
<form action="" method="post">
   <h5>Min. Amount To Play Lucky Number Game :</h5>
  <p>Example : <b>10 <?php echo $base_currency_u; ?>.</b></p>
<div class="ui large left icon input">
  <input placeholder="Lucky Number Minimum" name="min_amount_luckynumber" value="<?php echo $min_amount_luckynumber; ?>" type="text">
