...
$min_amount_cointale = $_POST['min_amount_cointale'];


if (!ctype_digit($min_amount_cointale)) {  
$number_message = '<div class="ui negative message">
  <div class="header">
   Please enter only numbers.
  </div></div>';
} else {

if ($min_amount_cointale <= 0 ) {
  $min_message = '<div class="ui negative message">
  <div class="header">
   Minimum amount you can set is 1 satoshi.
  </div></div>';
} else {

$updateuser = UpdateCointale($min_amount_cointale);
...
<nav class="navbar navbar-expand-lg navbar navbar-dark" style="background-color: #05437b;">
 ...
 <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item active" href="settings_cointale"><i class="rocket icon"></i>Cointale Settings</a>
...
<div class='column'> 
<center><h1>Cointale Settings</h1>
<br>
<br>
<form action="" method="post">
   <h5>Min. Amount To Play Cointale Game :</h5>
  <p>Example : <b>10 <?php echo $base_currency_u; ?>.</b></p>
<div class="ui large left icon input">
  <input placeholder="Coin Tale Minimum" name="min_amount_cointale" value="<?php echo $min_amount_cointale; ?>" type="text">
