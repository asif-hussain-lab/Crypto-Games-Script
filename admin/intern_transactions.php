...
$lastid = InternTransactionNumber();
...
<nav class="navbar navbar-expand-lg navbar navbar-dark" style="background-color: #05437b;">
 ...
 <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item active" href="intern_transactions"><i class="exchange icon"></i>Users Internal Transactions</a>
...
<br>
<br>
<center><h3>Total Intern Transactions = <a class="ui teal big label"><?php echo $lastid; ?></a></h3></center>
<br>
